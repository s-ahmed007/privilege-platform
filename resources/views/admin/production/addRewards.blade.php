...
{{--                                           href="{{url("branch-offers/create?id=".$value->id)}}">Add Offer</a>--}}
                                       <a class="btn btn-primary" href="{{url("admin/reward/create?branch_id=".$value->id)}}">Add Reward</a>
                                    </td>
                                </tr>
                            @endforeach
                        @else
