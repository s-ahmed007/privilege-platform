    ...
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_content">
                    <br/>
                    <form class="form-horizontal form-label-left" method="post" action="{{ url('/update-custom-point') }}">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" name="custom_point_id" value="{{ $offer_details->customizedPoint->id }}">
                        <input type="hidden" name="branch_id" value="{{ $offer_details->branch_id }}">
                        <div class="row">
                            <!--PRICES-->
                            <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-9 col-xs-12">
                                        <select class="form-control" name="point_customize_type" required>
                                            @if(isset($offer_details->customizedPoint->point_type) && $offer_details->customizedPoint->point_type == \App\Http\Controllers\Enum\PointCustomizeType::weekly)
                                            ...
                                            @elseif(isset($offer_details->customizedPoint->point_type) && $offer_details->customizedPoint->point_type == \App\Http\Controllers\Enum\PointCustomizeType::daily)
                                                <option value="{{\App\Http\Controllers\Enum\PointCustomizeType::weekly}}">
                                                    Weekly
                                                </option>
                                            ...
                                            @elseif(isset($offer_details->customizedPoint->point_type) && $offer_details->customizedPoint->point_type == \App\Http\Controllers\Enum\PointCustomizeType::hourly)
                                                <option value="{{\App\Http\Controllers\Enum\PointCustomizeType::weekly}}">
                                                    Weekly
                                                </option>
                                                <option value="{{\App\Http\Controllers\Enum\PointCustomizeType::daily}}">Daily
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        ...
                                        @if(isset($offer_details->customizedPoint->date_duration))
                                            <?php
                                            $point_details = $offer_details->customizedPoint->date_duration;
                            ...
                            " type="text" class="form-control" placeholder="DD-MM-YYYY" name="date_to">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12" style="margin: 10px 0px -10px 0px">
                                        @if(isset($offer_details->customizedPoint['weekdays']))
                                            <?php $point_details = $offer_details->customizedPoint->weekdays[0]; ?>
                                            {{--$customize_point->weekdays[0]['sat']--}}
                                            <label><input type="checkbox" name="sun" 
                                                <?php if ($point_details['sun'] == 1) {
                                                    echo 'checked';
                                                }?> > Sun</label>
                                            <label><input type="checkbox" name="mon" 
                                                <?php if ($point_details['mon'] == 1) {
                                                    echo 'checked';
                                                }?> > Mon</label>
                                            <label><input type="checkbox" name="tue" 
                                                <?php if ($point_details['tue'] == 1) {
                                                    echo 'checked';
                                                }?> > Tue</label>
                                            <label><input type="checkbox" name="wed" 
                                                <?php if ($point_details['wed'] == 1) {
                                                    echo 'checked';
                                                }?> > Wed</label>
                                            <label><input type="checkbox" name="thu" 
                                                <?php if ($point_details['thu'] == 1) {
                                                    echo 'checked';
                                                }?> > Thu</label>
                                            <label><input type="checkbox" name="fri"
                                                <?php if ($point_details['fri'] == 1) {
                                                    echo 'checked';
                                                }?> > Fri</label>
                                            <label><input type="checkbox" name="sat"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        @if(isset($offer_details->customizedPoint['point_multiplier']))
                                            <input type="number" class="form-control" name="point_multiplier" min="1" placeholder="Put numeric value except zero"
                                                   value="{{$offer_details->customizedPoint['point_multiplier']}}">
                                        @else
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        @if(isset($offer_details->customizedPoint['description']))
                                            <input type="text" class="form-control" name="description"
                                                   value="{{$offer_details->customizedPoint['description']}}">
                                        @else
