...
<div class="container offers-container">
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-sm-12 col-xs-12 offers">
            {{--sub cat 1 block--}}
            @if(count($all_sub_cats_1) > 6)
                <button class="btn btn-activate pull-right" onclick="hideCategory1(this)"><i class="fa fa-angle-down"></i></button>
            @endif
            <?php
            $cat1_div_1 = $all_sub_cats_1->take(6);
            $cat1_div_2 = $all_sub_cats_1->slice(6);
            ?>
            <div class="row">
                @foreach($cat1_div_1 as $subcategory)
                    <div class="col-md-2 col-sm-2 col-xs-4 category-block">
                        <a href="{{url('offers_copy/'.$selected_category->type.'/'.$subcategory->cat_name)}}">
                ...
                @endforeach
                <div class="hide_cat_div1" style="display:none;">
                    @foreach($cat1_div_2 as $subcategory)
                        <div class="col-md-2 col-sm-2 col-xs-4 category-block">
                            <a href="{{url('offers_copy/'.$selected_category->type.'/'.$subcategory->cat_name)}}">
                                <div class="" style="display: inline-block;">
                                    <img src="{{$subcategory->icon}}" alt="Royalty BD category" class="lazyload" width="50" height="50">
