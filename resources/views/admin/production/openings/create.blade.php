...
<script>tinymce.init({selector: '#summernote', plugins: "lists, advlist, image, link, media"});</script>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_content">
                    <br/>
                    <form class="form-horizontal form-label-left" method="post" action="{{ url('/openings') }}"
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Requirements:</label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <textarea id="summernote" name="requirements"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
