            ...
            <div class="x_panel">
                <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="post"
                          action="{{ url('/openings/'.$opening->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="text" class="form-control" placeholder="Position" name="position"
                                       required="required" value="{{$opening->position}}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="text" class="form-control" placeholder="Duration" name="duration"
                                       required="required" value="{{$opening->duration}}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="text" class="form-control" placeholder="Salary" name="salary"
                                       required="required" value="{{$opening->salary}}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Deadline:</label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="date" name="deadline" required="required" value="{{$opening->deadline}}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Requirements:</label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                    <textarea id="summernote" name="requirements">
