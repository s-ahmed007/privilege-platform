    ...
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_content">
                    <br/>
                    <form class="form-horizontal form-label-left" method="post" action="{{ url('/admin/vouchers/'.$voucher_details->id) }}">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        @if(isset($voucher_details->date_duration))
                                            <?php
                                            $dates = $voucher_details->date_duration;
                                            ?>
                                            <input type="date" class="form-control" name="date_from2" value="{{date('Y-m-d', strtotime($dates[0]['from']))}}" required>
                                        @else
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        @if(isset($voucher_details->date_duration))
                                            <input type="date" class="form-control" name="date_to2" value="{{date('Y-m-d', strtotime($dates[0]['to']))}}" required>
                                        @else
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <select class="form-control" name="redeem_duration">
                                            ...
                                            @for($i=1; $i<=31; $i++)
                                                <option value="{{$i}}" {{ $i == $voucher_details->redeem_duration ? 'selected':''}} >{{$i}}</option>
                                            @endfor
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input type="text" class="form-control" name="heading"
                                               value="{{$voucher_details->heading}}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input type="number" class="form-control" name="actual_price" id="actual_price" 
                                           placeholder="Actual price" value="{{intval($voucher_details->actual_price)}}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <select class="form-control" name="discount_type" id="discount_type">
                                            <option value="1" {{$voucher_details->discount_type == 1 ? 'selected':''}}>Flat</option>
                                            <option value="2" {{$voucher_details->discount_type == 2 ? 'selected':''}}>Percentage</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input type="number" class="form-control" name="discount" placeholder="Discount" value="{{intval($voucher_details->discount)}}" id="discount">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-6 col-xs-12">Selling Price:<span style="color:red;font-size: 1.5em">*</span></label>
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input type="number" class="form-control" name="selling_price" id="selling_price" placeholder="Selling Price" value="{{intval($voucher_details->selling_price)}}" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <select class="form-control" name="commission_type">
                                            <option value="1" {{$voucher_details->commission_type == 1 ? 'selected':''}}>Flat</option>
                                            <option value="2" {{$voucher_details->commission_type == 1 ? 'selected':''}}>Percentage</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input type="number" class="form-control" name="commission" placeholder="Commission" value="{{intval($voucher_details->commission)}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-6 col-xs-12">Available Deals:</label>
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input type="number" class="form-control" name="counter_limit" placeholder="Write available deal amount" value="{{intval($voucher_details->counter_limit)}}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-6 col-xs-12">Purchase Limit:</label>
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input type="number" class="form-control" min="1" name="scan_limit" placeholder="Purchase limit" value="{{$voucher_details->scan_limit}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-6 col-xs-12">Description:<span style="color:red;font-size: 1.5em">*</span></label>
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea id="textarea1" name="description">{{$voucher_details->description}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-6 col-xs-12">Terms & Conditions:<span style="color:red;font-size: 1.5em">*</span></label>
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea id="textarea2" name="tnc">{{$voucher_details->tnc}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-6 col-xs-12">Priority:<span style="color:red;font-size: 1.5em">*</span></label>
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input type="number" class="form-control" name="priority" placeholder="Priority" value="{{$voucher_details->priority}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <select class="form-control" name="valid_for">
                                            @if($voucher_details->valid_for == ValidFor::ALL_MEMBERS)
