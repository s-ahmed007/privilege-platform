...
<div class="right_col" role="main">
    ...
    <div class="panel-body">
        <form action="{{ url('admin/main_cat/') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="category_name" class="form-control" placeholder="Food & Drinks" required
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="category_type" class="form-control" placeholder="food_and_drinks" required
            ...
            <!-- <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="category_caption" class="form-control" placeholder="Text that shows in offers page banner" required>
                </div>
            </div> -->
<!--             <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="file" name="category_banner" required>
                </div>
            </div> -->
