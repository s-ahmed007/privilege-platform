...
<div class="right_col" role="main">
    <div class="page-title">
        <div class="title_left">
            ...
            @endif
            <h3>Sub Category 2 Create/ Edit/ Display</h3>
            <a type="button" class="btn btn-create" href="{{ url('/admin/sub_cat_2/create') }}" style="margin-left: unset;">+ Create New Sub Category 2</a>
        </div>
    </div>
