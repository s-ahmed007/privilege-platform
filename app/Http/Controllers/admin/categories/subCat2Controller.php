...
class subCat2Controller extends Controller
{
    protected $request;
    ...
    {
        $categories = SubCat2::orderBy('id', 'DESC')->get();

        return view('admin.production.categories.sub_cat_2.index', compact('categories'));
    }
    ...
    {
        return view('admin.production.categories.sub_cat_2.create');
    }
    ...
    public function store()
    {
        ...
        // }
        return redirect('admin/sub_cat_2')->with('success', 'Category updated successfully');
    }
    ...
    {
        $category = SubCat2::findOrFail($id);

        return view('admin.production.categories.sub_cat_2.edit', compact('category'));
    }
    ...
    public function update($id)
    {
        ...
        //     $get_current_image_name = SubCat2::select('icon')->where('id', $id)->first();
    ...
    {
//        $rel_id = CategoryRelation::where('sub_cat_2_id', $id)->get()->pluck('id');
...
//        }
        CategoryRelation::where('sub_cat_2_id', $id)->update([
            'sub_cat_2_id' => null,
        ]);
        ...
        return redirect()->back()->with('success', 'Sub cat 2 deleted successfully');
    }
}
