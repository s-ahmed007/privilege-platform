    ...
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_content">
                    <br/>
                    <form class="form-horizontal form-label-left" method="post" action="{{ url('/partner/post') }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                ...
                                <input type="text" class="form-control" placeholder="Post Header" name="postHeader" required="required"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                  <span style="color: red;">
                                    @if ($errors->getBag('default')->first('postLink'))
                                          {{ $errors->getBag('default')->first('postLink') }}
                                      @endif
                                  </span>
                                <input type="text" class="form-control" placeholder="External link(Optional)" name="postLink"/>
                            </div>
                        </div>
                        <div class="form-group">
