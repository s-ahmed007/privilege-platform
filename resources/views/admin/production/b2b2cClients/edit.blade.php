    ...
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_content">
                    <br/>
                    <form class="form-horizontal form-label-left" method="post" action="{{ url('/update-b2b2c-client/'.$client_info->b2b2c_id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                ...
                                <input type="text" class="form-control" placeholder="Name" name="name" value="{{$client_info->name}}" required/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                ...
                                <input type="text" class="form-control" name="phone" maxlength="14" minlength="14" value="{{$client_info->phone}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                ...
                                <input type="text" class="form-control" placeholder="Email" value="{{$client_info->email}}" name="email" required/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="text" class="form-control" placeholder="Username" value="{{$client_info->username}}" name="username"/>
                            </div>
                        </div>
                        <div class="form-group">
                             <span style="color: #E74430;">
                            ...
                            <?php $decrypted_password = (new functionController)->encrypt_decrypt('decrypt', $client_info->password);?>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="text" class="form-control" placeholder="Password" name="password" value="{{$decrypted_password}}"/>
                            </div>
                        </div>
                        <div class="form-group">
